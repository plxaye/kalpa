  ...
  'targets': [
    {
      ...
      'sources': [
		...
		'controls/activex/ax_host.cc',
		'controls/activex/ax_host.h',
		'controls/activex/flash_view.cc',
		'controls/activex/flash_view.h',
		'controls/activex/html_view.cc',
		'controls/activex/html_view.h',
		'controls/activex/mediaplay_view.cc',
		'controls/activex/mediaplay_view.h',
		'controls/activex/silverlight_view.cc',
		'controls/activex/silverlight_view.h',
		'controls/activex/webbrowser_view.cc',
		'controls/activex/webbrowser_view.h',
		'controls/activex/xcp_ctrl.h',
		'controls/activex/xcp_host.h',
    ...
    },  # target_name: views_unittests
    {
      ...
      'sources': [
        ...
        'examples/flash_example.cc',
        'examples/flash_example.h',
        'examples/html_example.cc',
        'examples/html_example.h',
        'examples/silverlight_example.cc',
        'examples/silverlight_example.h',
        'examples/webbrowser_example.cc',
        'examples/webbrowser_example.h',
    ...
    },  # target_name: views_examples_lib
    {
	  ...
	  'copies': [ {
         ...
         'files' : [
            'examples/Construction.swf',
            'examples/FullScreen.wmv',
            'examples/SilverlightDemo.xap',
         ],
        },
      ],
      'conditions': [
