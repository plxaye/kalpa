...
#ifndef UI_VIEWS_EXAMPLES_EXAMPLES_VIEWS_DELEGATE_H_
#define UI_VIEWS_EXAMPLES_EXAMPLES_VIEWS_DELEGATE_H_
...
namespace examples{
class ExamplesViewsDelegate : public ViewsDelegate {
 public:
  ExamplesViewsDelegate();
  virtual ~ExamplesViewsDelegate();
...
*/  
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ExamplesViewsDelegate);
};

}
}  // namespace views

#endif  // UI_VIEWS_EXAMPLES_EXAMPLES_VIEWS_DELEGATE_H_
