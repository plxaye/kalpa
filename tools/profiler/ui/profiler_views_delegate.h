...
#ifndef TOOLS_PROFILER_UI_VIEWS_DELEGATE_H_
#define TOOLS_PROFILER_UI_VIEWS_DELEGATE_H_
...
namespace profiler{
class ProfilerViewsDelegate : public ViewsDelegate {
 public:
  ProfilerViewsDelegate();
  virtual ~ProfilerViewsDelegate();
...
*/  
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(ProfilerViewsDelegate);
};

}
}  // namespace views

#endif  // TOOLS_PROFILER_UI_VIEWS_DELEGATE_H_
